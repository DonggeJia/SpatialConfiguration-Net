...
root = test_path # change this parameter into train_path, valid_path, and test_path to realize image preprocessing separately.
...
for image_path in image_paths:
		...
		if filename in ['3145','3150', '3151','3153']:
