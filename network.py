...
class SCN(nn.Module):
    def __init__(self, img_ch, n_landmarks):
        ...
        self.local_conv1 = nn.Conv2d(img_ch, 64, kernel_size=3, stride=1, padding=1)
        ...
        self.local_conv14 = nn.Conv2d(64, n_landmarks, kernel_size=3, stride=1, padding=1)
        self.local_conv15 = nn.Upsample(scale_factor=1/16, mode='bilinear', align_corners=True)
        self.local_conv16 = nn.Conv2d(n_landmarks, 64, kernel_size=11, stride=1, padding=5)
        self.local_conv16_2 = nn.LeakyReLU(0.1, inplace=True)
        self.local_conv17 = nn.Conv2d(64, 64, kernel_size=11, stride=1, padding=5)
        self.local_conv17_2 = nn.LeakyReLU(0.1, inplace=True)
        self.local_conv18 = nn.Conv2d(64, 64, kernel_size=11, stride=1, padding=5)
        self.local_conv18_2 = nn.LeakyReLU(0.1, inplace=True)
        self.local_conv18_5 = nn.Conv2d(64, n_landmarks, kernel_size=11, stride=1, padding=5)
        ...
        self.local_conv19 = nn.Upsample(scale_factor=16, mode='bicubic', align_corners=True)
